/**********************************************************************************************************
 ...
 Program notes:
 The program below will display both the € and $ signs through compiler of Xcode on Mac
 The program will ONLY display the $ sign through the compiler CodeBlocks on Mac
 Please see attached screenshot in Webcourses submission
...
#include <stdio.h>
#include <stdlib.h>
#define SIZE 3 // Used to determine how many values the user can input
#define DOLLAR 1.19 // €1 = $1.19
#define EURO 0.84 // $1 = €0.84
#define ERROR_CHECK 3 // Used during the error check on the users input (Replicated from CA1)
